...
function ContentView() {
    ...
    function ButtonShare(btnIdx) {
        ...
        return (<button type="button" class="btn btn-primary  btn-lg share-1 d-flex justify-content-center position-relative end-0" style={{ width: "100%" }} onClick={handleClick}>
    ...
    function SetPost(data, cond, btnIdx) {
        return(<div className=" border border-dark d-grid gap-3" style={{ alignItems: 'flex-start', paddingLeft: "2%", paddingTop: "2%", paddingBottom: "2%", paddingRight: "2%" }}>
            <div className="d-flex justify-content-center   " >
                ...
                <div className="rounded-3 d-grid gap-3" style={{ paddingLeft: "1%", width: "150%" }}>
                    <p> <b>Max @max</b></p>
